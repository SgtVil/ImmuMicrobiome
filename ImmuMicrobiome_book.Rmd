...
## Usage of various functions {style="text-align: justify"}
...
**pos** and the **neg1** (log_2\_ratio - log10_abundance) and between
the ***neg1*** and **neg2** (log2_neg_ratio - log10_neg_abundance). This
