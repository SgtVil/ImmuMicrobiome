...
```{r fig.height=7, fig.width=10, message=FALSE, warning=FALSE, cache=TRUE, label="plsda1"}
...
```{r fig.align='center', fig.show="hold", message=FALSE, warning=FALSE, cache=TRUE, label="variance 1"}
var= metabolomic %>%
...
knitr::include_graphics("Igaseq plots/png/MO101_random generation_.png")
```
